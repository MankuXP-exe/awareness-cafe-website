...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 relative bg-[#080808]">
            ...
            {[
              {
                icon: "📍",
                title: "Visit Us",
                content: "Gadi Budhera Road, Near Vaishno Devi Mandir, Haryana 122505, India",
              },
              {
                icon: "📞",
                title: "Call Us",
