            ...
            >
              ...
              {filteredImages.length > 1 && (
                <button
                  ...
                  className="absolute left-2 sm:left-6 top-1/2 -translate-y-1/2 z-[80] w-11 h-11 sm:w-14 sm:h-14 
              ...
              {filteredImages.length > 1 && (
                <button
                  ...
                  className="absolute right-2 sm:right-6 top-1/2 -translate-y-1/2 z-[80] w-11 h-11 sm:w-14 sm:h-14 
                    rounded-full bg-[#1a1a1a]/80 border border-[#333] backdrop-blur-md
                    text-white hover:text-[#C6FF00] hover:border-[#C6FF00]/40 hover:bg-[#1a1a1a] 
                    transition-all duration-300 flex items-center justify-center
                    active:scale-90 shadow-lg shadow-black/30"
              ...
              >
                <div className="relative w-full h-[60vh] sm:h-[75vh] rounded-2xl overflow-hidden">
                  <AnimatePresence initial={false} custom={direction} mode="wait">
                    <motion.div
                      key={selectedImage.src || selectedImage.image_url}
                      custom={direction}
